...
- 2026-05-23: Have I Been Pwned en OSINT: brechas, dominios verificados y contexto antes de alarmar (fallback editorial: la seccion `Ideas (candidatas)` seguia sin ninguna entrada libre `- [ ]`; tras revisar el historico real de `blog/`, se publica una herramienta/metodologia inedita como tema principal, evitando repetir `Ahmia`, `Favicon hashing` y `Historia OSINT: Skripal`, y manteniendo el foco en exposicion defensiva, verificacion de dominio y contexto antes de sobrerreaccionar)
