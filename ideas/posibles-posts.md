...
- 2026-06-02: Historia OSINT: Navalny, patrones de viaje y la paciencia de correlacionar sin fabular (fallback editorial: la seccion `Ideas (candidatas)` seguia sin ninguna entrada libre `- [ ]`; para mantener la alternancia herramienta/historia, se toma la siguiente historia realmente inedita del backlog enlazado en `ideas/historias-osint.md`, evitando repetir `crt.sh`, `AbuseIPDB` y `Ahmia`, y manteniendo el foco en cronologias, patrones de viaje y corroboracion multifuente)
