...
- 2026-05-10: recon-ng en OSINT: workspaces, marketplace y automatizacion controlada con mas metodo que magia (fallback editorial: `Ideas (candidatas)` seguia sin entradas libres; se publica una herramienta no tratada como post principal en `blog/`, evitando repetir `ArchiveBox`, `Overpass Turbo` y `Wikidata`, y dejando explicito que el backlog obligatorio estaba agotado)
